const ru: {[key: string]: any} = {
  ...
  share: {
    h1: "Расшарить воркспейс",
    p1: "Поделитесь этим рабочим пространством со своими коллегами или товарищами по команде. Пользователь сможет читать, изменять и экспортировать воркспейс, но не может его удалять, переименовывать или шарить.",
    p2: "Этот воркспейс в настоящее время используется совместно c (нажмите, чтобы удалить)"
  },
